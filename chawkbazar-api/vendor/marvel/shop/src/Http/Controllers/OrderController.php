...
class OrderController extends CoreController
{
    ...
    public function findByTrackingNumber(Request $request, $tracking_number)
    {
        $user = $request->user();
        try {
            $order = $this->repository->with(['products', 'status', 'children.shop','children.dispute'])->findOneByFieldOrFail('tracking_number', $tracking_number);
     ...
     */
    public function changeOrderStatus($request,$order, $status)
    {
