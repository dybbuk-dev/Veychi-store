...
class CompanyUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
           ...
           // "legal_representative" => [ 'array'],
            //"legal_representative.id"=>['exists:legal_representative,id'],
            //"dni_document" => ['array'],
            //"dni_document.id"=>['exists:dni_document,id']
    ...
    public function messages()
    {
        return [
            ...
            'legal_representative.id.exists'=>'Legal representative does not exists',
            'dni_document.required' => 'DNI document is required',
            'dni_document.array' => 'DNI document is not valid json',
            "dni_document.id.exists"=>"DNI document does not exists"
        ];
    }
