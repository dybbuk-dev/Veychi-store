        ...
        <div className="flex flex-wrap pb-8 border-b border-dashed border-gray-300 my-5 sm:my-8">
          ...
          <Card className="w-full sm:w-8/12 md:w-2/3">
            ...
            <Input
              ...
              {...register("balance.payment_info.accountType")}
              variant="outline"
              className="mb-5"
              error={t(errors.balance?.payment_info?.accountType?.message!)}
            />
            <Input
            ...
            <Input
              label={"IBAN"}
              {...register("balance.payment_info.iban")}
              variant="outline"
              required
            />{" "}
            <br />
            <Input
              label={"SWIFT"}
              {...register("balance.payment_info.swift")}
              variant="outline"
              required
            />
          </Card>
